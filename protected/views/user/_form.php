...
<?php $form=$this->beginWidget('CActiveForm', array(
    ...
    ?>
        ...
        <div class="row">
            ...
            <?php // echo $form->textField($model,'roles', array('size'=>60,'maxlength'=>64)); ?>
   ...
   $form->hiddenField($model,'roles',array('type'=>"hidden",'size'=>2,'maxlength'=>2));
            $model->roles = "non_approved";
        }
    ?>
